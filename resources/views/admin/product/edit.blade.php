		...
		<div class="row">
            <div class="col-md-offset-3 col-md-6">
                ...
                <div class="page" style="border: solid #000">
                    ...
                    {!! Form::open(array('route' => array('admin.product.update', $product->slug),'method' => 'PUT', 'files' => true)) !!}
                        ...
                        <div class="form-group">
                            ...
                            <hr>
                            <center>
                            <label>Si desea cambiar la imágen actual haga click en examinar</label>
                            {!! Form::file('image') !!}
                            </center>
                            <hr>
                        </div>
